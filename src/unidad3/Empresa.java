...
/**
 * Identificador, puede tener números y letras Nombre Dirección tipo web
 * ingresosAnuales gastosEmpleados Array de Empleados
 * 
 */
public class Empresa {
	 ...
	 * decir la longitud del array de Empleados.(1 punto)
	 * 
	 * @return
	 */
	 ...
	 * dentro del tipo introducido. Si se introduce -1 en puesto, devolverá el que
	...
	Empleado empleadoMasCaro(int puesto) {
		...
		// Primero comprobamos si hay que recorrer todos los empleados o solo los del
		// puesto
		if (puesto == -1) {
