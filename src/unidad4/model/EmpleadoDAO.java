...
public class EmpleadoDAO {
	...
	/**
	 * Funcion que recibe una conexion y los datos del empleado con un empleadoDO Y
	 * inserta en BD el registro
	 * 
	 * @param con      Conexión activa a la BD
	 * @param empleado objeto de la clase EmpleadoDO con los datos a insertar
	 * @return -1 si falla o no hay datos y 1 si ha podido insertar el registro en
	 *         BD
	 */
